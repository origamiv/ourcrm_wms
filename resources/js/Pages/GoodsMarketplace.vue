...
@media (max-width: 900px) {
    ...
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-name { display: flex; background: #fff; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-id { display: inline-flex; width: 38px; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-name { display: inline-flex; width: calc(100% - 38px); }
