...
.catalog-table-wrap { overflow-x: auto; border: 1px solid #e1ebe3; border-radius: 8px; } table { width: 100%; border-collapse: collapse; min-width: 1080px; } th, td { box-sizing: border-box; padding: 12px 10px; border-bottom: 1px solid #edf2ee; text-align: left; vertical-align: top; font-size: 13px; overflow-wrap: anywhere; } th { background: #f4faf5; color: #53675a; font-weight: 600; white-space: nowrap; } th:nth-child(4), td:nth-child(4) { width: 260px; } tbody tr:last-child td { border-bottom: 0; }
...
.product-name { width: 240px; max-width: 240px; color: #1d3025; font-weight: 600; white-space: normal; overflow-wrap: anywhere; word-break: normal; } small, .muted { color: #7d8a81; } .good-link { color: #1e892f; font-weight: 600; overflow-wrap: anywhere; }
