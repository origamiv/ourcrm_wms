...
function productName(row: MarketplaceRow) { return row.name || row.offer_id || row.external_sku || row.external_id || "—"; }
...
.mmp-mobile-title, .mmp-inline-title { display: none; }
