...
.filter-menu { position: relative; min-width: 170px; } .filter-menu:last-child { min-width: 210px; } .filter-menu summary { display: flex; align-items: center; gap: 6px; min-height: 40px; list-style: none; cursor: pointer; border: 1px solid #d5e3d8; border-radius: 7px; padding: 5px 12px; background: #fff; color: #1c3024; } .filter-menu summary::-webkit-details-marker { display: none; } .filter-menu summary::after { content: "▾"; margin-left: auto; color: #687a70; } .filter-menu[open] summary { border-color: #1e892f; } .filter-title { white-space: nowrap; } .summary-chips { display: flex; flex-wrap: wrap; gap: 4px; } .filter-options { display: flex; flex-direction: column; position: absolute; z-index: 10; top: calc(100% + 5px); left: 0; min-width: 100%; max-height: 280px; overflow-y: auto; padding: 7px; border: 1px solid #d5e3d8; border-radius: 7px; background: #fff; box-shadow: 0 8px 20px rgb(18 51 34 / 12%); } .filter-options label { display: flex; flex: 0 0 auto; align-items: flex-start; gap: 7px; width: 100%; padding: 7px 5px; color: #1c3024; white-space: normal; overflow-wrap: anywhere; cursor: pointer; } .filter-options input { flex: 0 0 15px; margin-top: 2px; min-width: 15px; }
