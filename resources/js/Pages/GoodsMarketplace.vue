...
@media (max-width: 900px) {
    ...
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row { display: grid; grid-template-columns: max-content minmax(0, 1fr) max-content; align-items: center; min-height: 44px; overflow: hidden; border: 1px solid #dcecef; border-radius: 10px; background: #fff; box-shadow: 0 2px 8px rgb(16 24 40 / 5%); }
    ...
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-name { display: flex; align-items: center; min-height: 42px; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-id { grid-column: 1; color: #0c1821; font-size: 11px; font-weight: 600; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-name { grid-column: 2; overflow: hidden; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-name .name-button { display: block; width: 100%; min-width: 0; overflow: hidden; padding: 0; border: 0; background: transparent; color: #0c1821; font-size: 15px; font-weight: 600; text-align: left; text-overflow: ellipsis; white-space: nowrap; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-name small { display: none; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row .mmp-marketplace { grid-column: 3; justify-content: flex-end; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded { display: block; background: #e1f3e7; border-color: #95c59d; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-id,
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-name,
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-marketplace { display: flex; background: #fff; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-id { display: inline-flex; width: 38px; }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-name { display: inline-flex; width: calc(100% - 115px); }
    .marketplace-catalog .catalog-table-wrap .mmp-mobile-row.mobile-card-expanded .mmp-marketplace { display: inline-flex; width: 77px; }
