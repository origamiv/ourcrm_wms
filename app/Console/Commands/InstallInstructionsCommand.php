...
В зависимости от типа записи в строке **Действия** могут быть доступны импорт и экспорт, настройка видимых колонок, открытие связанных сущностей, документы, история изменений, восстановление или выполнение операции. Перед использованием дополнительной команды проверьте её результат в карточке и журнале раздела.
MARKDOWN;
