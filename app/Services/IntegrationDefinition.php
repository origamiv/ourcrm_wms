...
final class IntegrationDefinition
{
    ...
    {
        $definitions = [
            'webhooks' => ['model' => \App\Models\IntegrationWebhook::class, 'fields' => ['name', 'shortname', 'status', 'client_id', 'service_id', 'type_hook_id', 'url', 'rules_id', 'cnt', 'dat_last_run', 'params'], 'details' => ['url', 'params'], 'links' => ['client_id' => \App\Models\Client::class, 'service_id' => \App\Models\IntegrationService::class, 'type_hook_id' => \App\Models\IntegrationHookType::class]],
