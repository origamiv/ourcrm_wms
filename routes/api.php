...
Route::middleware(['auth:sanctum', EnsureWmsAccess::class])->group(function () {
    ...
    Route::middleware(EnsureWmsAccess::class.':admin')->group(function () {
        ...
        Route::put('/fulfillment/goods_marketplace/{id}', [App\Http\Controllers\MarketplaceCatalogController::class, 'update'])->whereNumber('id');
        ...
        Route::post('/logistics/{catalog}', [App\Http\Controllers\FulfillmentCatalogController::class, 'store'])->whereIn('catalog', ['orders', 'shipments', 'order_statuses', 'order_sources', 'order_cancel_statuses', 'logistic_companies', 'shipment_statuses']);
        Route::put('/logistics/{catalog}/{id}', [App\Http\Controllers\FulfillmentCatalogController::class, 'update'])->whereIn('catalog', ['orders', 'shipments', 'order_statuses', 'order_sources', 'order_cancel_statuses', 'logistic_companies', 'shipment_statuses'])->whereNumber('id');
        Route::delete('/logistics/{catalog}/{id}', [App\Http\Controllers\FulfillmentCatalogController::class, 'destroy'])->whereIn('catalog', ['orders', 'shipments', 'order_statuses', 'order_sources', 'order_cancel_statuses', 'logistic_companies', 'shipment_statuses'])->whereNumber('id');
