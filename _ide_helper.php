...
namespace Illuminate\Database\Schema {
    ...
    class PostgresBuilder {
         ...
         * 
         *
         * @see \App\Mixins\SchemaMixin::createSchema()
         * @param string $name
         * @return void 
         * @static 
         */
        ...
        {
            \Illuminate\Database\Schema\PostgresBuilder::createSchema($name);
        }

        /**
         * 
         *
         * @see \App\Mixins\SchemaMixin::dropSchema()
         * @param string $name
         * @return void 
         * @static 
         */
        ...
        {
            \Illuminate\Database\Schema\PostgresBuilder::dropSchema($name);
        }
    ...
    class Builder {
        ...
        public static function createSchema($name)
        {
            \Illuminate\Database\Schema\Builder::createSchema($name);
        }
        ...
        public static function dropSchema($name)
        {
            \Illuminate\Database\Schema\Builder::dropSchema($name);
        }
