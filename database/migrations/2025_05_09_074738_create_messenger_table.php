...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('messenger.messengers', function (Blueprint $table) {
            $table->id();
        ...
        // Artisan::call('db:seed',['class'=>"database\\seeders\\MessengerSeeder"]);
    }
    ...
    {
        Schema::dropIfExists('chats.messengers');
    }
};
