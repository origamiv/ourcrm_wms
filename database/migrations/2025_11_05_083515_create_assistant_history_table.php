...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('messenger.assistants_history', function (Blueprint $table) {
            $table->id();
            $table->integer('assistant_id')->nullable()->comment('ID ассистента наш');
            $table->integer('version')->default(1)->comment('Версия');
    ...
    {
        Schema::dropIfExists('messenger.assistants_history');
    }
};
