...
return [
    'entities' => [
        ...
        'goods' => ['entity' => App\Models\Good::class, 'table' => 'goods.goods', 'authorize' => [App\Services\AccessService::class, 'isAdmin'], 'fields' => ['id', 'name', 'shortname', 'code', 'parent_id', 'parent_code', 'type_good', 'type_unit', 'barcodes', 'articul', 'is_from_external', 'is_category', 'has_children', 'level', 'goodcard_id', 'status', 'tenant_id', 'created_at', 'updated_at', 'deleted_at']],
