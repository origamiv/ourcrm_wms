...
return [
    'entities' => [
        ...
        'cell_goods' => ['entity' => App\Models\CellGood::class, 'table' => 'wms.cell_goods', 'authorize' => [App\Services\AccessService::class, 'isAdmin'], 'fields' => ['id', 'warehouse_id', 'cell_id', 'cnt', 'put_at', 'leave_at', 'tenant_id', 'src', 'created_at', 'updated_at', 'deleted_at']],
