...
return [
    'entities' => [
        ...
        'delivery_services' => ['entity' => App\Models\DeliveryService::class, 'table' => 'wms.delivery_services', 'authorize' => [App\Services\AccessService::class, 'isAdmin'], 'fields' => ['id', 'name', 'shortname', 'status', 'icon', 'color', 'is_order_edit', 'prefix', 'folder', 'marketplace_id', 'tenant_id', 'created_at', 'updated_at', 'deleted_at']],
